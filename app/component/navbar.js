...
export default function Navbar() {
 ...
 const showNavbar = ['/', '/pokemon', '/about', '/favorites'].includes(pathname)|| pathname.startsWith('/search');
    ...
    return (
        <nav style={{
        ...
        }} className='sticky top-0 z-50 bg-blue-950/90 gap-0.5 '>
            <div style={{ display: 'flex', alignItems: 'center' }}>
               ...
               <img
                ...
                <Link href="/favorites" className='mx-10'>Favorites</Link>
            </div>
            
            <div style={{ display: 'flex', gap: '1.5rem' }}>
               <form action="" onSubmit={handleSearch} style={{ display: 'flex', gap: '0.5rem' }}>
